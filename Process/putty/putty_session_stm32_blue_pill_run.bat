...
echo [%DATE% %TIME%] [INFO] Launching PuTTY with session "STM32_BluePill"...

rem Запуск приложения с сохраненной сессией
start "" "%APP_PATH%" -load "STM32_BluePill"
